      ...
      <div className="product-carousel-container">
        ...
        <div className="product-carousel" ref={scrollRef}>
          {products.map((product) => (
            <div className="product-card" key={product.id_produto || product.id}>
              <img src={product.imagens?.[0] || product.image} alt={product.nome || product.name} />
              <h4>{product.nome || product.name}</h4>
